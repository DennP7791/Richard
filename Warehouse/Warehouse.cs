    ...
    public class Warehouse
    {
        ...
        public void Start()
        {
            using (bus = RabbitHutch.CreateBus("host=localhost"))
            {
                ...
                bus.Subscribe<EnrichedOrderRequestMessageToLocalWarehouse>("warehouse" + id,
                ...
                // same queue. 
                bus.Subscribe<EnrichedOrderBroadcastRequestMessage>("warehouse" + id,
                    HandleOrderEvent);
        ...
        private void HandleOrderEvent(EnrichedRetailerOrderRequestMessage message)
        {
