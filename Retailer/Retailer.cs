    ...
    public class Retailer
    {
        ...
        private void HandleOrderReplyMessage(OrderReplyMessage message)
        {
            ...
            else if (message.DaysForDelivery == 2)
            {
                ...
                EnrichedOrderBroadcastRequestMessage broadcastRequestMessage = new EnrichedOrderBroadcastRequestMessage
                {
                ...
                bus.Publish<EnrichedOrderBroadcastRequestMessage>(broadcastRequestMessage);
            }
        }
